    ...
    return (
        <div className="page-container animate-fade-in">
            ...
            <div className="gastos-top">
                <div className="card stat-card stat-investment">
                    ...
                    <div className="stat-content">
                        <span className="text-muted font-bold text-xs uppercase tracking-wider mb-1">Inversión en Stock (Vista)</span>
                        <span className="stat-value">${totalInView.toLocaleString('es-AR')}</span>
                    </div>
                </div>

                <div className="card gastos-tabs-card">
                    ...
                    <div className="tab-meta">
                        <Layers size={18} />
                        <div>
                            <span className="tab-meta-label">Categorías</span>
                            <span className="tab-meta-value">{catData.length}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="filters-bar glass">
                        ...
                        <div className="filters-selects">
                            ...
                            <div className="filter-field" style={{ justifyContent: 'flex-end' }}>
                                <Button variant="secondary" size="sm" onClick={() => { setSearchTerm(''); setFilterVehiculo(''); setFilterCategoria(''); setFilterSucursal(''); setPage(1); }}>
                                    Limpiar Filtros
                                </Button>
                            </div>
                        </div>
            ...
            <Modal
                ...
                footer={
                    <>
                        <Button variant="secondary" onClick={() => { setShowCreateGasto(false); setEditGasto(null); }}>
                            Cancelar
                        </Button>
                        <Button
                            variant="primary"
                    ...
                    {!editGasto && (
                        <>
                            <div className="input-group">
                                <label className="input-label">Unidad de stock *</label>
                                <select
                                    className="input-control"
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }}>
                                <div className="input-group">
                                    <label className="input-label">Rubro / Concepto *</label>
                                    <select
                                        className="input-control"
                                ...
                                <div className="input-group">
                                    <label className="input-label">Centro de costo (sede) *</label>
                                    <select
                                        className="input-control"
            ...
            <Modal
                ...
                footer={
                    <>
                        <Button variant="secondary" onClick={() => { setShowCreateCat(false); setEditCat(null); }}>
                            Cancelar
                        </Button>
                        <Button
                            variant="primary"
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    <div className="input-group">
                        <label className="input-label">Nombre del Rubro *</label>
                        <Input
